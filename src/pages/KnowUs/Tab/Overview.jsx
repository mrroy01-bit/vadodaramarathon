...
const Overview = () => {
  return (
    <>
      <section className="w-[95%] max-w-4xl mt-28 md:mt-28 mx-auto my-8 px-2 md:px-6 py-6 bg-white ">
        <h1 className="mt-4 mb-3 text-xl md:text-2xl font-semibold">Overview</h1>
        <p className="mb-4 text-base md:text-2xl text-left text-gray-700">
        ...
        <img
          src={OverViewImg}
          alt="Vadodara Marathon"
          className="w-full h-auto rounded-md mb-4"
        />
        <p className="mb-4 text-base md:text-lg text-left text-gray-700">
        ...
        <p className="mb-4 text-base md:text-lg text-left text-gray-700">
          ...
          accredited to AFI, SAI, SAG, and BDAAA. Vadodara Marathon is also a
        ...
        <h3 className="mt-4 text-xl md:text-2xl font-bold">Mission Statement</h3>
        <h4 className="mt-2 text-lg md:text-xl font-semibold">SPORTS SEVA SWACHHTA</h4>
        ...
        <h3 className="mt-4 text-xl md:text-2xl font-bold">Vision Statement</h3>
        <p className="mb-4 text-base md:text-lg text-left text-gray-700">
